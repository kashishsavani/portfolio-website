...
const HomeSection = () => {
  return (
    <div
      className="container-fluid mainsection d-flex align-items-center justify-content-center"
      id="home"
    >
      <div className="row align-items-center d-md-flex w-85">
        <div className="col-lg-6 col-md-6   text-center text-lg-start order-2 order-md-1">
          <div className="containfirst ">
            <h1 className="hello">
              Hello <img src={wavingHand} alt="Waving Hand" />
              <br />
              I'm <span>Dhaval Bhimani</span>
            </h1>
            <h4 className="mobile">Mobile Application Designer & Developer</h4>
            <p className="welcome">
              Welcome to my profile! I am a highly skilled and experienced
              mobile app freelancer ready to bring your ideas to life. With a
              deep understanding of mobile app design & development, I
              specialize in creating innovative and user-friendly applications
              for iOS and Android platforms.
            </p>
            <p>
              In addition to development, I also have strong UI/UX design
              skills, ensuring that each app is not only functional but also
              visually appealing and intuitive for users. As a freelancer, I
              offer flexibility, professionalism, and a commitment to delivering
              top-notch results. Let’s work together to create an exceptional
              mobile experience!
            </p>
            <div className="d-flex flex-wrap justify-content-center justify-content-lg-start gap-3 buttonss">
              ...
              <button className="btn btn-contraa">
                <img
                  src={contraIcon}
                  alt="Contra Icon"
                  className="img-fluidcontra imgcontraa"
                />
              </button>
            </div>
