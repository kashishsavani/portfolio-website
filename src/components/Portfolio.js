...
const portfolioItems = [
  ...
  {
    logo: "./img/images/logo-11.png",
    name: "Outgoer",
    stores: ["appstore", "playstore"],
  },
  {
    logo: "./img/images/logo-12.png",
    name: "MeetUrFriends",
    stores: ["appstore", "playstore"],
  },
  {
    logo: "./img/images/logo-13.png",
    name: "Insight Timer",
    stores: ["appstore", "playstore"],
  },
  {
    logo: "./img/images/logo-14.png",
    name: "Mimizaur",
    stores: ["appstore", "playstore"],
  },
  {
    logo: "./img/images/logo-15.png",
  ...
  return (
    <div className="container text-center mt-5" id="portfolio">
      ...
      <p className="mt-3 text-muted">
        Welcome to my mobile app portfolio! It's proud for me to craft
        innovative and user-centric mobile applications that cater to various
        needs and industries. My portfolio represents a diverse range of
        projects I have successfully delivered, combining cutting-edge
              ...
              <div className="custom-store-icons d-flex">
                  ...
                  <img
                    ...
                    onClick={() =>
                      (window.location.href =
                        "https://apps.apple.com/in/app/appatme-dating-chat-and-meet/id6499432093")
                    }
                ...
                {item.stores.includes("playstore") && (
                  <img
                    ...
                    onClick={() =>
                      (window.location.href =
                        "https://play.google.com/store/apps/details?id=com.ddg.appatme&pli=1")
                    }
                    style={{ cursor: "pointer" }}
                  />
                )}
