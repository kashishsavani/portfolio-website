...
const Portfolio = () => {
  ...
  const portfolioItems = [
...

    {
      ...
      name: "Faras E-commerce",
      category: "designing",
    },
    {
      id: 8,
      img: "./img/portfolio-2.png",
      logo: "./img/images/logo-2.png",
      name: "Hinotes",
      category: "designing",
    },
    {
  ...
  return (
    <div className="portfolio mt-md-5">
      ...
      <p>
        Discover my impressive app development portfolio, showcasing a diverse
        range of innovative and user-centric mobile applications. Each project
        exemplifies my commitment to delivering exceptional user experiences
        while harnessing cutting-edge technology.
      </p>

      <div className="btn-group gap-3">
        <button
          className={`btn btn-custom ${
            category === "development" ? "btn-yellow" : ""
          }`}
      ...
      {visibleCards < filteredItems.length && (
        <div className="d-flex justify-content-center mt-4">
          <button
            className="btn fw-bold px-4 py-2 load-more-btn"
            onClick={() => setVisibleCards(visibleCards + 2)}
          >
            Load More
          </button>
        </div>
