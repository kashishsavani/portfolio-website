...
const Testimonials = () => {
  ...
  return (
    <div className="container text-center mt-5" id="testimonials">
      <h2 className="fw-bold">My <span style={{ color: "#e7b900" }} >Testimonials</span></h2>
      <p className="mt-3 text-muted">
      My clients have faith in me. I’m always keep them ahead of their competitors by serving them top notch IT solutions. They have never diminishing faith in me, and thus, they work with me time and again.
      </p>

      <div className="custom-carousel-container mt-5">
        <div className="custom-carousel-wrapper" style={{ display: "flex", overflowX: "auto", alignItems: "flex-start" }}>
          {testimonials.map((testimonial, index) => (
            <div className="custom-testimonial-card p-3 mx-2" key={index} style={{ flexDirection: "column", height: "auto", minHeight: "300px" }}>
              ...
              <div className="client-name d-flex mt-4">
                ...
                <div className="client-pro">
                  ...
                  <div className="client-name-rating px-3" style={{ display: "flex", flexDirection: "column", alignItems: "flex-start" }}>
